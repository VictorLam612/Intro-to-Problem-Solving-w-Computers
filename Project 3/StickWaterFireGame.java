...
public class StickWaterFireGame {
   ...
   public void playRound(String playerChoice) {
      ...
      */
      ...
      if (playerChoice.equals("F")) {
         ...
         else if (computerChoice.equals("W")) {
            computerScore += 1;
         }
      }
   }
   ...
   */
   public boolean isValidInput(String inputStr) {
      ...
      if (inputStr.equalsIgnoreCase("F") || inputStr.equalsIgnoreCase("S")|| inputStr.equalsIgnoreCase("W"))  {
         return true;
      }
   ...
   public String getScoreReportStr(){
      String currentStandings = ("total plays: " + rounds + "\n" + "Your Score: " + playerScore + ", computer score: " + computerScore);
